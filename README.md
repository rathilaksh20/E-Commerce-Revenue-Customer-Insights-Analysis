...
->What percentage of customers return within 18 months?
...
->Analyzed cumulative monthly sales
...
->Monthly order distribution charts

->Revenue percentage by product category (Pie Chart)

->Top 5 sellers' revenue distribution

->Year-over-Year growth analysis
  
->Customer spending comparison graphs
